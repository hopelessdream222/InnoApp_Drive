...
function afficheDetailRecette() {
    ...
    xhr.onload = function () {
        ...
        if (xhr.status === 200) {
            ...
            elt.innerHTML = "<div class='col-sm-5'>"+
                            ...
                            "<div class='col-sm-7'>"+
                                "<div class='product-information'><!--/product-information-->"+
                                    "<h2>"+xhr.responseXML.getElementsByTagName("recetteLib")[i].firstChild.nodeValue+"</h2>"+
                                    "<span>"+
            ...
            elt.insertAdjacentHTML("beforeend","</tbody></table></div><div><!--/product-information--></div>");
            //Client
